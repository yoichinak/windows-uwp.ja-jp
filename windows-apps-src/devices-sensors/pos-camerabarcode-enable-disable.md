...
| 値の名前  | 値型 | 値 | 状態 |
| ----------- | --------- | -------|--------|
| [有効化]      | DWORD     | 1 (既定)<br/>0 |  Windows に付属するソフトウェア デコーダーを有効にします。 <br/> Windows に付属するソフトウェア デコーダーを無効にします。 |

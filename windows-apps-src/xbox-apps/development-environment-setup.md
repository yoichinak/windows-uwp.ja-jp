...
description: Xbox 開発環境で UWP を設定およびテストする方法について説明します。これは、ローカルネットワーク経由で Xbox One コンソールに接続されている開発用 PC で構成されています。
ms.date: 02/08/2017
ms.topic: article
...
- [Windows Insider プログラム](https://insider.windows.com/)  

...
#### <a name="accelerometer"></a>[加速度計](https://docs.microsoft.com/uwp/api/windows.devices.sensors.accelerometer)
...
#### <a name="magnetometer"></a>[磁力計](https://docs.microsoft.com/uwp/api/windows.devices.sensors.magnetometer)
...
#### <a name="language"></a>[言語](https://docs.microsoft.com/uwp/api/windows.globalization.language)

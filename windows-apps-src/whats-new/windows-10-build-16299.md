...
機能 | 説明
 :------ | :------
アカウント管理 | [Azure AD テナントとパートナー センター アカウントに関連付け](../publish/associate-azure-ad-with-dev-center.md)て複数のアカウント ユーザーを追加するときの柔軟性が向上しました。 複数の Azure AD テナントを 1 つのパートナー センターに関連付けることも、1 つの Azure AD テナントを複数のパートナー センター アカウントに関連付けることもできます。

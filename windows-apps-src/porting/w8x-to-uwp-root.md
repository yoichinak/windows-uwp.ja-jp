...
**ドキュメント**
* [Windows ランタイム リファレンス](https://docs.microsoft.com/uwp/api/)
* [すべての Windows デバイス用のユニバーサル Windows アプリの構築](https://go.microsoft.com/fwlink/p/?LinkID=397871)
* [アプリの UX の設計](https://docs.microsoft.com/previous-versions/windows/hh767284(v=win.10))

...
<table>
<tr><th>シナリオ</th><th>時点</th><th>ユーザーの作業</th><th>インタラクション クラス</th></tr>
...
-   [Visual Studio 診断ツールを使用してパフォーマンスを分析する](/visualstudio/profiling/profiling-feature-tour)

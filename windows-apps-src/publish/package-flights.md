...
パッケージを指定し、必要なオプションを構成したら、 **[ストアに提出]** をクリックします。 パッケージ フライトに対して、[アプリの認定プロセス](the-app-certification-process.md)が開始されます。 パッケージに含まれるパッケージする必要がありますに従っていることに注意してください、 [Microsoft Store ポリシー](store-policies.md)すべての要求送信と同様に、します。

...
ms.locfileid: "93035005"
---
# <a name="put-apps-and-add-ons-on-sale"></a>アプリとアドオンの販売

期間限定で特売することにより Microsoft Store でアプリやアドオンの販促活動をすることができます。 製品を低い価格帯で提供することも、割引率を適用することもできます。 また、販売をすべてのユーザーに提供するか、または他の製品の1つを所有している顧客に対して排他的なオファーにするかを選択できます。

> [!NOTE]
> サブスクリプションのアドオンでは、販売価格はサポートされていません。
...
> [!IMPORTANT]
> セール価格は、Xbox One を含め、Windows 10 デバイスのユーザーにのみ表示されます。 他の製品の所有者にのみ提供される売上は、Windows 10 バージョン1607以降のお客様のみに表示されます。
> 
...
3.  を作成できます。 **[すべて選択]** をクリックして、アプリを利用できるすべての市場で特売を提供することも、1 つまたは複数の市場を選択することもできます。 必要に応じて、市場グループの名前を入力できます。 選択が完了したら、 **[作成]** をクリックします  (グループ内の市場を後で編集する場合は、グループ名をクリックします)。
...
1.  進行中のアプリまたはアドオンの送信の [ **価格と可用性** ] ページで、[ **販売価格** ] セクションに進みます。
2.  更新する特売を見つけて変更します。

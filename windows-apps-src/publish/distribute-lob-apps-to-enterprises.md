...
組織でデバイスを管理するために Microsoft エンドポイント Configuration Manager または Microsoft Intune を使用している場合は、これらのツールを使用して LOB アプリを展開できます。 詳細と例については、次の記事をご覧ください。

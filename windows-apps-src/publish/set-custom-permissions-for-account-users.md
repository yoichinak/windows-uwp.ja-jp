...
| Developer            | パッケージをアップロードし、アプリおよびアドオンを申請できます。また、[使用状況レポート](usage-report.md)で統計情報の詳細を確認できます。 [デバイス間のエクスペリエンス](https://developer.microsoft.com/windows/project-rome)機能にアクセスできます。 財務情報やアカウントの設定を表示することはできません。   |

...
カテゴリとして [ **ゲーム** ] を選択した場合は、少なくとも1つのサブカテゴリ (ゲーム用の *ジャンル* ) を選択する必要があります。 ゲームに該当するジャンルを必要な数だけ選択できます。 ゲームを Xbox のユーザーに公開するには、[Xbox Live クリエーターズ プログラム](/gaming/xbox-live/get-started-with-creators/get-started-with-xbox-live-creators)を有効にするか、[概念の承認](../gaming/concept-approval.md)プロセスを通過する必要がある点に注意してください)。 
...
<tr>
    <td>書籍＆参考資料</td>
    <td>電子ブック リーダー <br> フィクション <br> ノンフィクション <br> 参照先</td>
  </tr>
  <tr>
    <td>Business</td>
  ...
  <tr>
    <td>開発者用ツール</td>
    <td>データベース <br> デザイン ツール <br> 開発キット <br> ネットワーク <br> リファレンス & トレーニング <br> サーバー <br> Utilities <br> Web ホスティング</td>
  </tr>
  <tr>
    <td>Education</td>
    <td>書籍＆参考資料 <br> 就学前教育 <br> 教育ツール <br> Language <br> 学習支援</td>
  </tr>
  <tr>
    <td>エンターテイメント</td>
    <td>(なし)</td>
  ...
  <tr>
    <td>ゲーム</td>
    <td>アクション＆アドベンチャー <br> カード＆ボード <br> カジノ <br> クラシック <br> 教育 <br> 家族 & 子供 <br> 格闘 <br> マルチプレーヤー オンライン バトル アリーナ <br> ミュージック <br> その他 <br> プラットフォーマー <br> パズル＆クイズ <br> レーシング＆フライト <br> RPG <br> シューティング <br> シミュレーション <br> スポーツ <br> 戦略 <br> ［ツール］ <br> Word</td>
  </tr>
  <tr>
    <td>行政 & 政治</td>
    <td>(なし)</td>
  ...
  <tr>
    <td>子供＆家族</td>
    <td>書籍＆参考資料 <br> エンターテイメント <br> 趣味 & おもちゃ <br> スポーツ & アクティビティ <br> トラベル</td>
  </tr>
  <tr>
    <td>ライフスタイル</td>

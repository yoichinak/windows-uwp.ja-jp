...
> [!IMPORTANT]
> これらの要件がここに記載されていない場合や、パートナーセンターにある場合でも、あらゆる地域の法的要件を満たす必要があります。
...
| Germany              | ギフト カード       | 2.24%                         | 2016 年 3 月     |
...
> [!NOTE]
>開発者アカウントに登録できる国と地域の一覧については、「[アカウントの種類、場所、料金](account-types-locations-and-fees.md)」を参照してください。  

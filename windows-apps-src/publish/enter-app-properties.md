...
ms.locfileid: "79210758"
---
# <a name="enter-app-properties"></a>アプリのプロパティの入力

**アプリの申請プロセス**の [[プロパティ]](app-submissions.md) ページでは、アプリのカテゴリを定義し、他の情報や宣言を入力します。 このページでは、アプリに関する完全な詳細情報を正確に指定してください。
...
- **[プロパティ]** ページの後半に表示される **[システム要件]** セクションで、 **[Windows Mixed Reality イマーシブ ヘッドセット]** について [[最小ハードウェア要件]](#system-requirements) または **[推奨されるハードウェア]** を選択します。
...
- **Windows 8.x 以前のお客様、または Windows Phone 8. x 以前のお客様の場合:**

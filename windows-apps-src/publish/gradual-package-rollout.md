...
ms.locfileid: "93034765"
---
# <a name="gradual-package-rollout"></a>段階的なパッケージのロールアウト

更新プログラムを送信に発行するときに、更新されたパッケージを Windows 10 (Xbox を含む) のお客様のアプリの顧客の割合に段階的にロールアウトすることを選択できます。 これにより、更新に確信が持てるよう、特定のパッケージのフィードバックと分析データを監視してから、より広くロールアウトできます。 この割合は、新しい申請を作成することなく、いつでも増やす (または更新を停止する) ことができます。 

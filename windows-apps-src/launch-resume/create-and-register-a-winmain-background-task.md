...
C++/WinRT の例では、 [**COM コクラス**](https://docs.microsoft.com/windows/uwp/cpp-and-winrt-apis/author-coclasses#implement-the-coclass-and-class-factory)としてバックグラウンドタスククラスを実装しています。

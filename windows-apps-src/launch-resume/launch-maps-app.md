...
| bingmaps:?collection=point.40.726966\_-74.006076\_Some%255FBusiness        | "(ラスベガス)" という名前\_のポイントを持つマップを表示します。                                                                                                                               |
...
| bingmaps:?collection=point.40.726966\_-74.006076\_Fake%255FBusiness%255Fwith%255FUnderscore                                                                        | アンダースコア付きの\_\_偽のビジネスという名前の画鋲を持つニューヨークを表示します。\_                                                  |

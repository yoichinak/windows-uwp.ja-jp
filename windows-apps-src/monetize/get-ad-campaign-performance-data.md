...
このメソッドは、パートナーセンターの [Ad キャンペーンレポート](/windows/uwp/publish/ad-campaign-report) によって提供されるものと同じデータを返します。 広告キャンペーンについて詳しくは、「[アプリ向けの広告キャンペーンの作成](./index.md)」をご覧ください。

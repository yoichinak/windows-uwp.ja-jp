...
次の例は、アプリの使用状況データを月単位で取得するための要求を示しています。 *applicationId* 値を、目的のアプリのストア ID に置き換えてください。
...
| monthlySessionCount       | long    | その月のユーザーセッションの数。                                              |

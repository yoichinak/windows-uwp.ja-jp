...
次の追加の方法は、xbox Developer ポータル (XDP) によって取り込まれたされ、XDP Analytics ダッシュボードで利用できる Xbox One ゲームの開発者アカウントで使用できます。

| シナリオ       | メソッド      |
|---------------|--------------------|
| 取得 |  <ul><li>[Xbox One のゲームの取得](get-xbox-one-game-acquisitions.md)</li><li>[Xbox One アドオンの取得](get-xbox-one-add-on-acquisitions.md)</li></ul> |
| エラー |  <ul><li>[Xbox One ゲームのエラー報告データを取得する](get-error-reporting-data-for-your-xbox-one-game.md)</li><li>[Xbox One ゲームのエラーの詳細を取得する](get-details-for-an-error-in-your-xbox-one-game.md)</li><li>[Xbox One ゲームのエラーのスタックトレースを取得する](get-the-stack-trace-for-an-error-in-your-xbox-one-game.md)</li><li>[Xbox One ゲームでエラーの CAB ファイルをダウンロードする](download-the-cab-file-for-an-error-in-your-xbox-one-game.md)</li></ul> |

...
|  configuredStatus   |  string   |  開発者により指定された広告キャンペーンのステータスを指定する次のいずれかの値です。 <ul><li>**アクティブ**</li><li>**非アクティブ**</li></ul>     |  No     |  アクティブ    |   はい    |       
...
|  type   | string    |  キャンペーンの種類を指定する次のいずれかの値です。 <ul><li>**有料**</li><li>**家**</li><li>**コミュニティ**</li></ul>      |   はい    |      |   はい    |       

...
> [!NOTE]
> Windows 10、バージョンは 1809 以降 ([SDK 17763](https://developer.microsoft.com/windows/downloads/windows-10-sdk)) を使用することができます[ **X:bind** ](https://docs.microsoft.com/windows/uwp/xaml-platform/x-bind-markup-extension)マークアップ拡張機能を使用する場所で[TemplateBinding](../../xaml-platform/templatebinding-markup-extension.md). 詳しくは、「[TemplateBinding マークアップ拡張](../../xaml-platform/templatebinding-markup-extension.md)」をご覧ください。
...
次の XAML は、`Checked`、`Unchecked`、`Indeterminate` の各状態に対する [**VisualState**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState) オブジェクトを示しています。 この例では、[**ControlTemplate**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.ControlTemplate) のルート要素である [**Border**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Border) に対して [**VisualStateManager.VisualStateGroups**](https://docs.microsoft.com/dotnet/api/system.windows.visualstatemanager?view=netframework-4.8) 添付プロパティを設定します。 `Checked` **VisualState**ことを指定します、 [**不透明度**](/uwp/api/Windows.UI.Xaml.UIElement.Opacity)の[**パス**](/uwp/api/Windows.UI.Xaml.Shapes.Path)という名前`CheckGlyph` (これは、前の例で説明) は 1 です。 `Indeterminate` **VisualState**ことを指定します、**不透明度**の[**楕円**](/uwp/api/Windows.UI.Xaml.Shapes.Ellipse)という`IndeterminateGlyph`は 1 です。 `Unchecked` **VisualState**にない[ **Setter** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter)または[**ストーリー ボード**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.Storyboard)のため、 [**チェック ボックスをオン**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.CheckBox)既定の外観を返します。
...
| `Unchecked` から `Checked`。       | [ **Setter** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter)の値、 `Checked` [ **VisualState** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState)が適用されるため、 [**不透明度** ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity)の`CheckGlyph`は 1 です。                                                                                                                                                         | X が表示される。                                |
| `Checked` から `Indeterminate`。   | [ **Setter** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter)の値、 `Indeterminate` [ **VisualState** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState)が適用されるため、 [**不透明度** ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity)の`IndeterminateGlyph`は 1 です。 **Setter**の値、 `Checked` **VisualState**が削除されるため、 [**不透明度**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush.opacity)の`CheckGlyph`は 0 です。 | 円が表示される。                            |
| `Indeterminate` から `Unchecked`。 | [ **Setter** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter)の値、 `Indeterminate` [ **VisualState** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState)が削除されるため、 [**不透明度** ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity)の`IndeterminateGlyph`は 0 です。                                                                                                                                           | 何も表示されない。                             |

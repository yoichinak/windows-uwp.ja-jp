...
ms.locfileid: "74258305"
---
# <a name="surface-dial-interactions"></a>Surface Dial の操作

surface Studio を使用した Surface Dial の ![イメージ](images/windows-wheel/dial-pen-studio-600px.png)  
...
| *Surface Dial アプリパートナー* | *開発者の Surface Dial* |
...
**すべての Windows 入力デバイスと同様に、アプリの機能に合わせて、Surface のダイヤル操作エクスペリエンスをカスタマイズおよび調整できます。**
...
Surface ペンを使用した ![表面ダイヤル](images/windows-wheel/dial-and-pen-400px.png)  
*Surface ペンを使用した surface Dial*
...
Windows Ink ツールバーのペン選択ツールを使用して ![Surface のダイヤルメニュー](images/windows-wheel/surface-dial-menu-inktoolbar-pen.png)  
*Windows Ink ツールバーのペン選択ツールを使用した Surface Dial メニュー*

Windows Ink ツールバーの [ストロークサイズ] ツールを使用して ![Surface のダイヤルメニュー](images/windows-wheel/surface-dial-menu-inktoolbar-strokesize.png)  
*Windows Ink ツールバーのストロークサイズツールを使用した Surface のダイヤルメニュー*

Windows Ink ツールバーの [ルーラー] ツールを使用して ![Surface のダイヤルメニュー](images/windows-wheel/surface-dial-menu-inktoolbar-ruler.png)  
*Windows Ink ツールバー用のルーラーツールを使用した Surface Dial メニュー*
...
| *アルファ背景を持つアイコン* | *既定のテーマを使用してホイールメニューに表示されるアイコン* | *ハイコントラスト白のテーマを持つホイールメニューに表示されるアイコン* |
...
1. まず、XAMLで UI (スライダーとトグル ボタンのみ) を宣言します。
   ...
   サンプルアプリの UI](images/windows-wheel/surface-dial-snippet-customtool1.png) の ![イメージ  
   *サンプルアプリの UI*
...
2. その後、分離コードで、Surface Dial メニューにカスタム ツールを追加し、[**RadialController**](https://docs.microsoft.com/uwp/api/Windows.UI.Input.RadialController) 入力ハンドラーを宣言します。 
   ...
   [  **CreateForCurrentView**](https://docs.microsoft.com/uwp/api/Windows.UI.Input.RadialController) を呼び出すことによって、Surface Dial (myController) の [**RadialController**](https://docs.microsoft.com/uwp/api/windows.ui.input.radialcontroller.createforcurrentview) オブジェクトへの参照を取得します。

   次に [**RadialControllerMenuItem.CreateFromIcon**](https://docs.microsoft.com/uwp/api/Windows.UI.Input.RadialControllerMenuItem) を呼び出すことによって、[**RadialControllerMenuItem**](https://docs.microsoft.com/uwp/api/windows.ui.input.radialcontrollermenuitem.createfromicon) (myItem) のインスタンスを作成します。 

   次に、その項目をメニュー項目のコレクションに追加します。

   [  **RadialController**](https://docs.microsoft.com/uwp/api/windows.ui.input.radialcontroller.buttonclicked)オブジェクトの入力イベント ハンドラー ([**ButtonClicked**](https://docs.microsoft.com/uwp/api/windows.ui.input.radialcontroller.rotationchanged) と [**RotationChanged**](https://docs.microsoft.com/uwp/api/Windows.UI.Input.RadialController)) を宣言します。
...
Surface Dial カスタムツールを使用してアクティブ化されたサンプルアプリ UI の ![イメージ](images/windows-wheel/surface-dial-snippet-customtool2.png)  
*Surface Dial カスタムツールを使用してアクティブ化されたサンプルアプリの UI*
...
**ユーザーが結果から簡単に回復できない場合は、アクションまたはコマンドをこのジェスチャにマップしない**
...
**Surface のダイヤルをクリックすると、モーダルツールを有効または無効にしない**
...
**相互作用は、移動ではなく、Surface のダイヤル位置に応答する必要があります。**
...
1. 最初に、XAMLで UI (4つのセクションと、それぞれのスライダーとトグル ボタン) を宣言します。
   ...
   サンプルアプリの UI](images/windows-wheel/surface-dial-snippet-customtool3.png) の ![イメージ  
   *サンプルアプリの UI*
...
Surface Dial カスタムツールを使用してアクティブ化されたサンプルアプリ UI の ![イメージ](images/windows-wheel/surface-dial-snippet-customtool4.png)  
*Surface Dial カスタムツールを使用してアクティブ化されたサンプルアプリの UI*
...
[チュートリアル: UWP アプリで Surface Dial (およびその他のホイールデバイス) をサポートする](radialcontroller-walkthrough.md)

### <a name="api-reference"></a>API リファレンス

- [**放射 Alcontroller**クラス](https://docs.microsoft.com/uwp/api/Windows.UI.Input.RadialController)
...
- [**アルファコントローラー構成**クラス](https://docs.microsoft.com/uwp/api/Windows.UI.Input.RadialControllerConfiguration) 
...
- [**アルファコントローラーメニュー**クラス](https://docs.microsoft.com/uwp/api/Windows.UI.Input.RadialControllerMenu) 
- [**放射 Alコントローラー menuitem**クラス](https://docs.microsoft.com/uwp/api/Windows.UI.Input.RadialControllerMenuItem) 
...
- [**放射 Alコントローラー Screencontact**クラス](https://docs.microsoft.com/uwp/api/Windows.UI.Input.RadialControllerScreenContact) 
...
- [**角丸 Alの Menuknownicon**列挙型](https://docs.microsoft.com/uwp/api/Windows.UI.Input.RadialControllerMenuKnownIcon) 
- [**放射型のシステム Menuitemkind**列挙型](https://docs.microsoft.com/uwp/api/Windows.UI.Input.RadialControllerSystemMenuItemKind) 
...
[入門チュートリアル: UWP アプリでの Surface Dial (およびその他のホイールデバイス) のサポート](https://github.com/Microsoft/Windows-tutorials-inputs-and-devices/tree/master/GettingStarted-RadialController)
...
[Windows クラシックデスクトップのサンプル](https://github.com/Microsoft/Windows-classic-samples/tree/master/Samples/RadialController)
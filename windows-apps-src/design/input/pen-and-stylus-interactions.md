...
これらの画像は、ペン入力が[**InkPresenter**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.inkcanvas.inkpresenter)によってどのように処理およびカスタマイズされるかを示しています。
...
- [はじめに: Windows アプリでインクをサポートする](../../get-started/ink-walkthrough.md)

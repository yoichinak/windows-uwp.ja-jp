...
| **HintAlign** | [AdaptiveTextAlign](#adaptivetextalign) | false | テキストの水平方向の配置。 グループ/サブグループ内のテキスト要素に対してのみ機能します。 |
...
* [Quickstart: Send a local toast and handle activation (クイックスタート: ローカル トースト通知の送信とアクティブ化の処理)](/archive/blogs/tiles_and_toasts/quickstart-sending-a-local-toast-notification-and-handling-activations-from-it-windows-10)

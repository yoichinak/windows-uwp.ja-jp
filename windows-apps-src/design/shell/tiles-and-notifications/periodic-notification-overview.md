...
詳細については、Windows 8.1 の[プッシュ通知と定期的な通知のサンプル](https://code.msdn.microsoft.com/windowsapps/push-and-periodic-de225603)をダウンロードして、Windows 10 アプリでソースコードを再利用する   に関するページを参照してください。

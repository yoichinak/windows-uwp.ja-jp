...
| [SystemNavigationManager.BackRequested](/api/windows.ui.core.systemnavigationmanager.backrequested) | ゲームパッドの B ボタン、<br/>タブレット モードの戻るボタン、<br/>ハードウェアの戻るボタン |

...
C++ の場合、Direct3D は行列構造体を使って、行列を 2 次元配列として宣言します。 次の例は、[**D3DMATRIX**](https://docs.microsoft.com/windows/desktop/direct3d9/d3dmatrix) 構造体を初期化して、均等スケーリング行列 (スケール ファクター "s") として動作するように設定する方法を示しています。

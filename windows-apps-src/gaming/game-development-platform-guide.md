...
Windows 10 の UWP の導入により、Windows 10 のタイトルはすべての Microsoft プラットフォームにまたがることができます。 以前のバージョンの Windows からの無料の移行では、Windows 10 クライアントの数が着実に増加しています。 これらの2つの組み合わせにより、Windows 10 のタイトルは、Microsoft Store を通じて膨大な数の顧客にリーチできるようになります。

さらに、Windows 10 には、ゲームに特に役立つ多くの新機能が用意されています。

-   メモリのページングの削減および全体的なメモリ システム サイズの削減
-   グラフィックス メモリの管理機能の向上により、フォアグラウンドのゲームに、より多くのメモリがアクティブに割り当てられ、保護されます。

## <a name="uwp-games-with-c-and-directx"></a>と DirectX をC++使用した UWP ゲーム
...
-   オーディオ: オーディオの再生やオーディオ エフェクトの適用に関する API です。 ゲームでオーディオ API を使う方法について詳しくは、「[ゲームのオーディオ](working-with-audio-in-your-directx-game.md)」をご覧ください。
    ...
    <p><strong>使う状況</strong></p>
    <p>ゲームがオーバーヘッドと遅延を最小限に抑えてサウンドを再生する必要があるときに、XAudio2 よりもはるかに使いやすく、サポートのC#オプションを使用して、オーディオグラフを使用します。</p>
    <p><strong>詳細情報</strong></p>
    ...
    <p><strong>詳細情報</strong></p>
    <p><a href="/windows/win32/medfound/microsoft-media-foundation-sdk">Microsoft メディア ファンデーション</a>の概要をご覧ください。</p></td>
    </tr>
    </tbody>
    </table>
...
[Xbox live](https://developer.microsoft.com/games/xbox/xboxlive/creator)作成者プログラムを使用すると、任意の開発者が xbox LIVE を UWP ゲームに統合し、xbox One と Windows 10 に発行できます。 最小限の開発時間で、サインイン、プレゼンス、ランキングなどの Xbox Live ソーシャル エクスペリエンスをタイトルに統合できます。 Xbox Live のソーシャル機能では、5,500 万人以上のアクティブ ゲーマーに情報を発信して、オーディエンスを自然に増やすことができます。

Xbox Live の他の機能にアクセスしたり、マーケティングと開発に関する専用のサポートを受けたり、Xbox One ストアのメイン ページで取り上げられたりすることを希望する場合は、[ID@Xbox](https://www.xbox.com/developers/id) プログラムへの登録を申し込んでください。 Xbox Live クリエーターズ プログラム、および ID@Xbox プログラムで利用できる機能については、[機能表](/gaming/xbox-live/developer-program-overview.md#feature-table)をご覧ください。

...
システムが **[Metadatapurged](https://docs.microsoft.com/uwp/api/windows.media.capture.appcapturemetadatawriter.MetadataPurged)** 推奨イベントのハンドラーを登録することで、アプリのメタデータの削除を開始したときに通知を受け取るように登録できます。

...
<table>
    ...
    <tr>
        <td><a href="https://www.tencent.com">Tencent ゲーム</a></td>
        ...
        <td>
            <ul>
                <li><a href="https://customers.microsoft.com/story/tencent-telecommunications-azure-service-fabric-windows-server-en">Tencent ゲームと Microsoft は、クラウドゲームソリューションを構築</a>して
    ...
    <tr>
        <td><a href="https://www.halowaypoint.com/">343の業界</a></td>
    ...
    <tr>
        <td><a href="https://web.ageofascent.com/">Illyriad ゲーム</a></td>
        ...
        <td>
            <ul>
                <li><a href="https://channel9.msdn.com/Shows/Cloud+Cover/Episode-228-Building-Games-with-Service-Fabric#time=06m52s">Service Fabric を使用したゲームの構築 (ビデオ)</a>
    ...
    <tr>
        ...
        <td>
            <ul>
                ...
                <li><a href="https://azure.microsoft.com/blog/the-walking-dead-no-mans-land-game-soars-to-1-with-azure-documentdb/">ウォークダウンは、Azure Cosmos DB (DOCUMENTDB API を介して) を使用して開発サイクルを高速化し、より魅力的なゲームプレイを</a>実現
            </ul>
        </td>
    </tr>
    <tr>
        <td><a href="http://www.crimecoast.com/">ピクセル電話</a></td>
        ...
        <td>
            <ul>
                <li><a href="https://channel9.msdn.com/Blogs/The-Game-Blog/BizSpark-Interview-with-Pixel-Squad-How-the-used-Azure-Cloud-Services-to-make-an-MMO-with-a-3-man-te">犯罪海岸 MMO ゲームで Azure Cloud Services</a>
             を使用する方法</ul>
        </td>
    </tr> 
</table>
...
* [ヒットマンと Azure: クラウドを使用してのみ可能な、見つけにくいターゲットのようなゲーム機能を作成](https://channel9.msdn.com/Series/Hitman)
* [ソースとしての Azure (ヒットセント、ゲーム Troopers、InnoSpark)](https://news.microsoft.com/features/game-developers-use-microsoft-azure-as-secret-sauce-for-scale-and-growth-2/)
* [Azure を使用した Bizspark プログラムでのゲームスタートアップ](https://blogs.technet.microsoft.com/bizspark_featured_startups/2015/09/25/azure-open-for-gaming-startups/)
...
| リージョン間での負荷分散によるパフォーマンスと可用性の向上 | 着信したゲーム要求をルーティング。 最初のレベルの負荷分散として使用できる。       | [Azure Traffic Manager](https://azure.microsoft.com/services/traffic-manager/) | 複数の自動フェールオーバー オプションと、均等または加重値に基づくトラフィック分散機能を提供。 オンプレミスとクラウド システムのシームレスな組み合わせが可能。 |
...
| ユーザー エンゲージメントにより使用と顧客維持を促進| あらゆるバック エンドからあらゆるプラットフォームにターゲット プッシュ通知を送信し、関心を引き出して特定のゲーム操作を促進する | [Azure Notification Hubs](https://azure.microsoft.com/services/notification-hubs/)| IOS、Android、Windows、Kindle、Baidu &mdash; すべての主要なプラットフォーム上の何百万ものモバイルデバイスにリーチする高速ブロードキャストプッシュ。 ゲームは、任意のバックエンド &mdash; クラウドまたはオンプレミスでホストできます。|
...
| モバイル アプリの開発、配布、ベータ テスト | モバイル アプリをテストして配布する。 アプリ パフォーマンスとユーザー エクスペリエンスを管理する。 | [HockeyApp](https://azure.microsoft.com/services/hockeyapp/)| クラッシュ レポートとユーザー メトリックをアプリの配布とユーザー フィードバック プラットフォームに統合。 Android、Cordova、iOS、OS X、Unity、Windows、Xamarin のアプリをサポート。 また、豊富な分析、クラッシュレポート、プッシュ通知、アプリの配布などを組み合わせたアプリについては、 [Visual Studio Mobile Center](https://visualstudio.microsoft.com/app-center/) &mdash; ミッションコントロールを検討してください。 |
...
* [開発者向けプログラム](e2e.md#developer-programs)
...
* ビルド 2017: [Microsoft Azure を使用したワールドクラスのゲームエクスペリエンスの提供: Halo、ヒットマン、ウォーキング (ビデオ) などのタイトルから学んだ教訓](https://channel9.msdn.com/Events/Build/2017/P4062)
...
* [Azure 上のゲームサービス (ビデオ)](https://channel9.msdn.com/Series/Gaming-Services-on-Azure)

## <a name="tools-and-other-useful-links"></a>ツールとその他の役立つリンク

* [MSDN フォーラム &mdash; Azure platform](https://social.msdn.microsoft.com/Forums/azure/home?category=windowsazureplatform)
* [クラウドベースのロードテストツール](https://visualstudio.microsoft.com/team-services/cloud-load-testing/)
* [Sdk とコマンドラインツール](https://azure.microsoft.com/downloads/)
...
* [ゲーム用 Azure](https://azure.microsoft.com/solutions/gaming/)

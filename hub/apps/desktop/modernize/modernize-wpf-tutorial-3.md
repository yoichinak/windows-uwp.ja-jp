...
title: XAML Islandsを使用して、UWP の予定表ビュー コントロールを追加します。
ms.topic: article
ms.date: 06/27/2019
ms.author: mcleans
author: mcleanbyron
...
---
# <a name="part-3-add-a-uwp-calendarview-control-using-xaml-islands"></a>パート 3:XAML Islandsを使用して、UWP の予定表ビュー コントロールを追加します。

...
title: Contoso Expensesアプリの .NET Core 3 への移行
ms.topic: article
ms.date: 06/27/2019
ms.author: mcleans
author: mcleanbyron
...
---
# <a name="part-1-migrate-the-contoso-expenses-app-to-net-core-3"></a>作業 1:Contoso Expensesアプリの .NET Core 3 への移行
...
この時点で、チュートリアルでは正常に移行されました、Contoso 経費アプリケーションを .NET Core の 3。 準備が整いました[第 2 部:XAML Islandsを使って UWP InkCanvas コントロールを追加](modernize-wpf-tutorial-2.md)します。

...
Windows アプリに AI を統合するさまざまな方法の詳細については、次を参照してください。 [Windows AI](https://docs.microsoft.com/windows/ai/)します。

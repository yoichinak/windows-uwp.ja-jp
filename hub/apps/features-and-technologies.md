...
Windows アプリで音声操作を使用するさまざまな方法の詳細については、「[音声操作](/windows/uwp/design/input/speech-interactions)」を参照してください。
